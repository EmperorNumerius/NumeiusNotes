    ...
    return Padding(
      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          IconButton(tooltip: 'Clear', onPressed: () { _expr.clear(); _result = ''; _save(); setState(() {}); }, icon: const Icon(Icons.clear_rounded, size: 16)),
          IconButton(tooltip: 'Calculate', onPressed: _run, icon: const Icon(Icons.play_arrow_rounded, size: 18)),
        ]),

    ...
    return Padding(
      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          IconButton(onPressed: () { _expr.clear(); _result = ''; _save(); setState(() {}); }, icon: const Icon(Icons.clear_rounded, size: 16), tooltip: 'Clear expression'),
          IconButton(onPressed: _run, icon: const Icon(Icons.play_arrow_rounded, size: 18), tooltip: 'Evaluate expression'),
        ]),
